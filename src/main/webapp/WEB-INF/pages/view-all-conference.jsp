...
<head>
  ...
  <!-- Site Properties -->
  <title>conference Hub List Of Conferences</title>
...
<c:forEach var="conference" items="${conference}">
  ...
  <div  style="cursor:pointer; "  onclick="redirect(this)" data-href= "/viewconference/${conference.id}/${conference.name}"' class="sixteen wide mobile eight wide tablet four wide computer column">
    <h4 class="ui dividing header">Date of Event <fmt:formatDate type="date" value="${conference.dateOfEvent}" /></h4>
  <div class="ui card">
    ...
    <div class="extra content">
      <a href="/viewconference/${conference.id}/${conference.name}" class="right floated created">view more</a>
