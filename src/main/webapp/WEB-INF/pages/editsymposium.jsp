...
<body>
	...
	<div class="ui modal" id="modal1">
		...
		<div
			...
			<form method="post" class="ui form step1"
				...
				<div class="field">
					<label>Symposium Name</label> <input value="${symposiumview.name}"
						type="text" name="name" placeholder="Symposium Name">


				</div>
				<div class="field">
					<label>College Name</label> <input
						value="${symposiumview.collegeName}" type="text"
						name="collegeName" placeholder="Name of Your College">
				</div>
				<div class="two fields">
					<div class="field">
						<label>Department</label> <input
							value="${symposiumview.department}" type="text" name="department"
					...
					<div class="fields">
						<div class="three wide field">
							...
							<div class="ui icon input">
								<input type="text"
									value="<fmt:formatDate pattern="MM/dd/yyyy" value="${symposiumview.dateOfEvent}" />"
									id="datepicker" name="dateOfEvent"> <i
				...
				<div class="eight wide field">
					...
					<textarea name="address">${symposiumview.address}</textarea>
				</div>
				<div class="field">
					...
					<div class="ui form">
						<div class="three fields">
							<div class="field">
								<label>Coordinator Name(1)</label> <input type="text" id="cname"
									value="${symposiumview.coordinators[0].name}"
									name="coordinators[0].name" placeholder="Name">
									<input type="hidden"
									id="id" value="${symposiumview.coordinators[0].id}"
									name="coordinators[0].id" >
							</div>
							<div class="field">
								<label>Coordinator Email(1)</label> <input type="text"
									id="cemailid" value="${symposiumview.coordinators[0].emailid}"
									name="coordinators[0].emailid" placeholder="Email">
							</div>
							<div class="field">
								<label>Coordinator Mobile No(1)</label> <input type="text"
									id="cphoneno" value="${symposiumview.coordinators[0].phoneno}"
									name="coordinators[0].phoneno" placeholder="Mobile no">
							</div>
						</div>
					</div>
				</div>
				<div class="field">
					<div class="ui form">
						<div class="three fields">
							<div class="field">
								<label>Coordinator Name(2)</label> <input type="text"
									value="${symposiumview.coordinators[1].name}"
									name="coordinators[1].name" placeholder="Name">
							</div>
							<div class="field">
								<label>Coordinator Email(2)</label> <input type="text"
									value="${symposiumview.coordinators[1].emailid}"
									name="coordinators[1].emailid" placeholder="Email">
							</div>
							<div class="field">
								<label>Coordinator Mobile No(2)</label> <input type="text"
									value="${symposiumview.coordinators[1].phoneno}"
									name="coordinators[1].phoneno" placeholder="Mobile no">
									<input type="hidden"
									id="id" value="${symposiumview.coordinators[1].id}"
									name="coordinators[1].id" >
							</div>
						</div>
					</div>
				...
				<div class="eight wide field">
					...
					<div class="ui icon input">
						<input value="${symposiumview.webAddress}" type="text"
							name="webAddress"> <i class="linkify icon"></i>
					</div>

				</div>
				<h4 class="ui dividing header">
					<div class="ui message green">
						<div class="header">Important Dates ,Events & Paper Titles</div>
				</h4>
				<div class="field">
					<div class="inline fields">
						<div class="five wide field">
							...
							<div class="ui icon input">
								<input
									value="<fmt:formatDate pattern="MM/dd/yyyy" value="${symposiumview.fromDate}" />"
									type="text" id="datepicker1" name="fromDate"> <i
									class="calendar icon"></i>
							</div>
						</div>
						<div class="six wide field">
							<label style="width: 95%">Selected papers are informed
								before</label>
							<div class="ui icon input">

								<input type="text" id="datepicker2"
									value="<fmt:formatDate pattern="MM/dd/yyyy" value="${symposiumview.toDate}" />"
									name="toDate"> <i class="calendar icon"></i>
							</div>
						</div>
				...
				<div class="field">
					<label>Events</label> <input name="events" type="hidden"
						id="mySingleField" value="${symposiumview.events}">
				...
				<div class="field">
					<label>Paper Titles</label> <input name="symposiumPapers"
						...
						value="${symposiumview.symposiumPapers}">
					<!-- only disabled for demonstration purposes -->
				...
				<div class="eight wide field">
					...
					<textarea name="impDescription">${symposiumview.impDescription}</textarea>
				</div>
				<h4 class="ui dividing header">
					<div class="ui message green">
				...
				<div class="six wide field">
					<label>Send Registration Email To:</label> <input
						value="${symposiumview.regEmail}" type="email" name="regEmail">
				</div>
				<h4 class="ui dividing header">
					<div class="ui message green">
				...
				<div class="inline field">
					<div class="ui toggle checkbox">
						<input type="checkbox"
							${symposiumview.fields.fullName eq true ? 'checked':'' }
							name="fields.fullName" tabindex="0" class="hidden"> <label>fullName</label>
					</div>
				</div>
				<div class="inline field">
					<div class="ui toggle checkbox">
						<input type="checkbox"
							${symposiumview.fields.phoneNumber eq true ? 'checked':'' }
							name="fields.phoneNumber" tabindex="0" class="hidden"> <label>phoneNumber</label>
					</div>
				</div>
				<div class="inline field">
					<div class="ui toggle checkbox">
						<input type="checkbox"
							${symposiumview.fields.email eq true ? 'checked':'' }
							name="fields.email" tabindex="0" class="hidden"> <label>email</label>
					</div>
				</div>
				<div class="inline field">
					<div class="ui toggle checkbox">
						<input type="checkbox"
							${symposiumview.fields.collegeName eq true ? 'checked':'' }
							name="fields.collegeName" tabindex="0" class="hidden"> <label>collegeName</label>
					</div>
				</div>
				<div class="inline field">
					<div class="ui toggle checkbox">
						<input type="checkbox"
							${symposiumview.fields.collegeId eq true ? 'checked':'' }
							name="fields.collegeId" tabindex="0" class="hidden"> <label>collegeId</label>
					</div>
				</div>
				<input name="fields.id"
						type="hidden" id="fields.id"
						value="${symposiumview.fields.id}">
						
				<input name="symposiumid"
						type="hidden" id="symposiumid"
	...
	<script src="<c:url value='/resources/dist/components/tab.min.js' />"> </script>
	<script src="<c:url value='/resources/dist/components/form.min.js' />"> </script>
	<script
		src="<c:url value='/resources/dist/components/transition.min.js' />"> </script>
	<script
		src="<c:url value='/resources/dist/components/dimmer.min.js' />"> </script>
	<script src="/resources/dist/components/modal.min.js"></script>
	<script
		src="<c:url value='/resources/dist/components/dropdown.min.js' />"> </script>
...
<script>
	...
	$('.ui.checkbox').checkbox();
	$(document).ready(function() {
		var selected="${symposiumview.country}";
