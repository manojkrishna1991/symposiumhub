...
<body>
	...
	<div class="alert success" style="text-align:center;">Password sent to your registered email id</div>
	</div>
	</c:if>
	<div class="ui main text container ">
		...
		<div class="ui segment">
			...
			<div class="ui message">
				<p>Enter user name click on submit. Password will be sent to your registered email </p>
			</div>
						...
						<div class="field">
							...
							<div class="ui left icon input">
								<input type="text" class="textbox1" id="userid"
									name="userid" placeholder="Username" required=""> <i
									class="user icon"></i>
							</div>
						</div>
