...
<body>
	...
	<div class="ui grid toplength"
		style="margin: 45px 13px; padding-top: 25px;">
		<div
			class="sixteen wide mobile eight wide tablet eight wide computer centered column ">
			...
			<div style="margin: auto;" class="ui icon message">
				<i class="write square icon"></i>
				<div class="content">
					<div class="header">Post Your Symposium</div>
			...
			<div
				...
				<form method="post" class="ui form step1"
					...
					<div class="field">
						...
						<div class="ui form">
							<div class="three fields">
								<div class="field">
									<label>Coordinator Name(1)</label> <input type="text"
										id="cname" name="coordinatorsAsList[0].name" placeholder="Name">
								</div>
								<div class="field">
							...
							<div class="three fields">
								...
								<div class="field">
									<label>Coordinator Email(2)</label> <input type="text"
										name="coordinatorsAsList[1].emailid" placeholder="Email">
								</div>
								<div class="field">
					...
					<div class="eight wide field">
						...
						<div class="ui icon input">
							<input type="text" name="webAddress"> <i
					...
					<div class="field">
						<div class="inline fields">
							<div class="five wide field">
								<label style="width: 143%">Last date for paper
									submission</label>
								<div class="ui icon input">
									<input type="text" id="datepicker1" name="fromDate"> <i
							...
							<div class="six wide field">
								...
								<div class="ui icon input">
									...
									<input type="text" id="datepicker2" name="toDate"> <i
										class="calendar icon"></i>
								</div>
							</div>
		...
		<c:if test="${step2}">
			...
			<div
				...
				<form method="post" class="ui form"
					action="<c:url value='symposiumstep3' />"
					modelAttribute="symposium" action="">
					<h4 class="ui dividing header">
						<div class="ui message green">
		...
		<c:if test="${step3}">
			...
			<div
				class="sixteen wide mobile eight wide tablet sixteen wide computer column">
				<form method="post" class="ui form"
					action="<c:url value='symposium' />" modelAttribute="symposium"
					action="">
					<h4 class="ui dividing header">
						<div class="ui message green">
					...
					<!-- <div class="inline fields">
						<label for="fruit">Choose Payment Type</label>
						<div class="field">
							<div class="ui radio checkbox">
								<input type="radio" name="paymentType" checked="" tabindex="0"
									class="hidden" value="payment offline"> <label>offline
									payment</label>
						...
						<div class="field">
							<div class="ui radio checkbox">
								<input type="radio" value="payment offline" name="paymentType" tabindex="1" class="hidden">
	...
	<script src="/resources/dist/components/form.min.js">
